...
print(my_set_variable[0])  # Esto no funciona. Por que?

my_list_variable.append('another string')
print(my_list_variable)

my_tuple_variable.append('a string')  # Esto no funciona. Por que?
my_tuple_variable = my_tuple_variable + ("a string",)
print(my_tuple_variable)
my_tuple_variable[0] = 'can I change this?'  # nuuup no se puede
